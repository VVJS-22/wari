...
const Header = () => {
    ...
    const layoutcss = () => {
        ...
        let target = link.getAttribute('data-sidebar-size');
        if(target === 'lg') {
    ...
    const hamburgericon = `"hamburger-icon" ${open ? "hamburger-icon" : "hamburger-icon open"}`;
            ...
            <div className="navbar-header">
                <div className="d-flex">
                    <button type="button" className="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger"
                        id="topnav-hamburger-icon" onClick={layoutcss} >
                ...
                <div className="d-flex align-items-center">
                    ...
                    {/* <div className="dropdown ms-1 topbar-head-dropdown header-item">
                        ...
                        <div className="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="/" className="dropdown-item notify-item language" data-lang="ch"
                                title="Chinese">
                            ...
                            <a href="/" className="dropdown-item notify-item language" data-lang="fr"
                                title="French">
